...
<header class="hero">
  ...
  <div class="container hero-inner">
    <span class="eyebrow">Noppa · EU AI Act Compliance</span>
    <h1>Voldoet jullie organisatie aan de <em>EU AI Act</em>?</h1>
    ...
    <div class="container">
      ...
      <div class="pillars">
        <div class="pillar">
          ...
          <p>Welke AI gebruik je, met welke rol (provider, deployer) en risicoklasse?</p>
        </div>
        <div class="pillar">
          <div class="pillar-icon">②</div>
          <h3>AI-geletterdheid (Art. 4)</h3>
          <p>Verplicht sinds 2 feb 2025 voor alle staf die met AI werkt.</p>
        </div>
        <div class="pillar">
          <div class="pillar-icon">③</div>
          <h3>Governance &amp; verantwoording</h3>
          <p>AI Officer, policy, DPIA/FRIA, risicoregister en escalatie.</p>
        </div>
        <div class="pillar">
          <div class="pillar-icon">④</div>
          <h3>Transparantie &amp; rechten</h3>
          <p>Disclosure, watermarking, OR-betrokkenheid, recht op uitleg.</p>
        </div>
        <div class="pillar">
          <div class="pillar-icon">⑤</div>
          <h3>Data &amp; technische waarborgen</h3>
          <p>Datakwaliteit, bias, logging, human oversight, robustness.</p>
        </div>
        <div class="pillar">
          <div class="pillar-icon">⑥</div>
          <h3>High-risk &amp; GPAI verplichtingen</h3>
          <p>Conformity assessment, technische documentatie en post-market monitoring.</p>
        </div>
      </div>
    ...
    <div class="container">
      ...
      <div id="gated-content" class="hidden">
        ...
        <div class="cta-block">
          ...
          <p>Noppa helpt organisaties met AI-governance, AI-literacy programma's, DPIA/FRIA en het inrichten van duurzame compliance — toegespitst op Microsoft 365 Copilot en bredere AI-portfolio's.</p>
...
/* Manual mail-client send — only triggered by explicit user click,
   so it doesn't surprise people with a popup mid-flow. */
